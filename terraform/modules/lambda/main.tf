...
# Lambda URIs are "{+lambda}/{+function}" e.g. "mkt/ping".
# We also support path matching at the root e.g. "mkt" but these require definining separate "_root" terraform resources.
