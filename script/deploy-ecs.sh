...
usage="Usage: deploy-ecs.sh [mkt-app-web|mkt-app-background] [sha]"
...
new_image="101624687637.dkr.ecr.us-west-2.amazonaws.com/mkt:$2"
...
aws ecs update-service --cluster mkt \
  --no-cli-pager \
  --region "$ecs_region" \
